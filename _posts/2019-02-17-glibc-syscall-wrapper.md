...
glic uses two method to make a wrapper for system calls: one is using the make-system.sh script to wrap and the other is using a function and some MACROS to wrap.
